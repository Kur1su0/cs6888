...
${afl_fuzz_PATH}/afl-fuzz -i afl_input -o afl_output ${tcc_PATH} -I $tcc_include_PATH -o /root/git/cs6888/assign1/test_file/mut2 /root/git/cs6888/assign1/test_file/mut2.c /root/git/cs6888/assign1/test_file/hello.c @@
